...
let clientListEl;
let processAllBtn;
let dashboardStatsEl;
let statTotalProcessedEl;
let statSuccessRateEl;
let statTotalTokensEl;
let statLastProcessedEl;
let clientModal;
let modalTitle;
let clientForm;
let closeModalBtn;
...
let clientNameInput;
let folderPathInput;
let apiKeyEnvVarInput;
let clientEnabledInput;
let deleteModal;
let deleteClientName;
...
function renderClientList() {
    ...
    clients.forEach((client) => {
        const folderStatus = client.folderStatus;
        ...
        dryRunBtn.disabled = folderStatus.inputPdfCount === 0 || !folderStatus.exists || isProcessing;
        ...
        processBtn.disabled = folderStatus.inputPdfCount === 0 || !folderStatus.exists || isProcessing;
